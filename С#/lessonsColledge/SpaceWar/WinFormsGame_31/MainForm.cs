namespace WinFormsGame_31
{
    public partial class MainForm : Form
    {
        ...
        {
            InitializeComponent();
            _enemyImage = Image.FromFile("EvilGuys.png");
            _heroImage = Image.FromFile("ImperialHero.png");
        }

        public void Reset()
        {
            _score = 0;
            ScoreMenuItem.Text = $"Счёт: {_score}";
            _counter = 0;
        ...
        private void MainForm_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyCode == Keys.Space)
            {
                ...
                var proj1 = new Projectile() { Location = new Point(_hero.Center.X + 10, _hero.Center.Y - 20), Speed = ps, Owner = Owners.Hero };
                var proj2 = new Projectile() { Location = new Point(_hero.Center.X + 10, _hero.Center.Y + 10), Speed = ps, Owner = Owners.Hero };
                FieldPanel.Controls.Add(proj1);
                FieldPanel.Controls.Add(proj2);
            }
